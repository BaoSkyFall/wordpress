...
class ReyCore
{
	...
	private function define_constants()
	{
		...
		$this->define( 'REY_CORE_THEME_MIN_VERSION', '1.7.0' );

		if( !defined('REY_DEV_MODE') ){
			$this->define( 'REY_CORE_VERSION', '1.7.0' );
		}
		else {
			// cache buster
	...
	function enqueue_admin_scripts(){
		...
		// Styles
		wp_enqueue_style('rey-core-admin-style', REY_CORE_URI . 'assets/css/admin'. $suffix .'.css', false, REY_CORE_VERSION, null);
	}
	...
	function enqueue_frontend_scripts()
	{
		...
		// Enqueue Styles
		wp_enqueue_style('reycore-styles', REY_CORE_URI . 'assets/css/styles'. $suffix .'.css', ['rey-wp-style'], REY_CORE_VERSION, null);
	}
