	...
	class ReyCore_Module__HeaderFixed
	{
		...
		public function header_classes($classes){
			...
			if( $this->shrink_is_enabled() ){
				...
				// if( get_theme_mod('header_fixed_activation_point', 0) !== 0 ){
				// 	$classes['start-absolute'] = '--start-absolute';
				// }
			}
		...
		{
			// $params['fixed_header_activation_point'] = get_theme_mod('header_fixed_activation_point', 0);
