...
if (!class_exists('REYAJAXFILTERS_Category_Filter_Widget')) {
	class REYAJAXFILTERS_Category_Filter_Widget extends WP_Widget {
		...
		public function update($new_instance, $old_instance) {
			...
			$instance['parent_click_behaviour']  = isset($new_instance['parent_click_behaviour']) ? sanitize_text_field($new_instance['parent_click_behaviour']) : $this->defaults['parent_click_behaviour'];
			...
			$instance['order_by']                =  isset($new_instance['order_by']) ? sanitize_text_field($new_instance['order_by']) : $this->defaults['order_by'];
			// Advanced
