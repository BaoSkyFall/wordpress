			...
			<div class="rey-widgetTabs-wrapper">
				...
				<div class="rey-widgetTabs-tabContent --active" data-tab="basic">
					...
					<p>
						...
						<input class="widefat" id="<?php echo $this->get_field_id('label_title'); ?>" name="<?php echo $this->get_field_name( 'label_title' ); ?>" type="text" value="<?php echo (!empty($instance['label_title']) ? esc_attr($instance['label_title']) : esc_html__('Featured product', 'rey-core')); ?>" placeholder="ex: <?php esc_html_e('Featured product', 'rey-core') ?>">
					</p>
				</div>
				<!-- end tab -->
