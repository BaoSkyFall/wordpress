	...
	class ReyCore_Compatibility__ElementorPro
	{
		...
		function handle_pagination($params){
			...
			if( isset($params['target']) ){
				$params['target'] = $params['target'] . ', .elementor-widget-wc-archive-products ul.products, .elementor.elementor-location-archive .reyEl-productGrid ul.products';
			}
		...
		function handle_ajax_filters($params){
			...
			if( isset($params['shop_loop_container']) ){
				$params['shop_loop_container'] = $params['shop_loop_container'] . ', .elementor-widget-wc-archive-products .reyajfilter-before-products, .elementor.elementor-location-archive .reyajfilter-before-products';
			}
			if( isset($params['not_found_container']) ){
				$params['not_found_container'] = $params['not_found_container'] . ', .elementor-widget-wc-archive-products .reyajfilter-before-products, .elementor.elementor-location-archive .reyajfilter-before-products';
			}
