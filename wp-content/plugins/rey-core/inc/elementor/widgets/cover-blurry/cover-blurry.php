	...
	class ReyCore_Widget_Cover_Blurry extends \Elementor\Widget_Base {
		...
		protected function _register_controls() {
			...
			$this->add_responsive_control(
				'arrow_width',
				[
					'label' => esc_html__( 'Arrow Width', 'rey-core' ) . ' (px)',
					'type' => \Elementor\Controls_Manager::NUMBER,
					'default' => '',
					'min' => 0,
					'max' => 1000,
			...
			$this->add_responsive_control(
				'arrow_height',
				[
					'label' => esc_html__( 'Arrow Height', 'rey-core' ) . ' (px)',
					'type' => \Elementor\Controls_Manager::NUMBER,
					'default' => '',
					'min' => 0,
					'max' => 1000,
			...
			$this->add_responsive_control(
				'arrow_size',
				[
					'label' => esc_html__( 'Arrow Size', 'rey-core' ) . ' (px)',
					'type' => \Elementor\Controls_Manager::NUMBER,
					'default' => '',
					'min' => 0,
					'max' => 1000,
			...
			$this->add_responsive_control(
				'bars_width',
				[
					'label' => esc_html__( 'Bars Width', 'rey-core' ) . ' (px)',
					'type' => \Elementor\Controls_Manager::NUMBER,
					'default' => '',
					'min' => 0,
					'max' => 1000,
			...
			$this->add_responsive_control(
				'bars_height',
				[
					'label' => esc_html__( 'Bars Height', 'rey-core' ) . ' (px)',
					'type' => \Elementor\Controls_Manager::NUMBER,
					'default' => '',
					'min' => 0,
					'max' => 1000,
		...
		public function render_footer(){
			...
			<div class="cBlurry-footer">
				<div class="cBlurry-footerInner <?php esc_attr_e($classes) ?>">
				<?php
					if( $social ){
						$this->render_social();
					}
