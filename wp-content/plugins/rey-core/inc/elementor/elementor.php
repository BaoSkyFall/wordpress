...
if(!class_exists('ReyCoreElementor')):
	...
	final class ReyCoreElementor
	{
		...
		function is_optimized_dom() {
			...
			return $this->legacy_mode('elementWrappers') !== true; // element wrappers are not enabled
		}
		...
		public function register_frontend_styles() {
			...
			wp_register_style( 'rey-core-elementor-frontend-dom-css', REY_CORE_URI . 'assets/css/elementor-frontend-dom-'. ( $this->is_optimized_dom() ? 'opt' : 'unopt' ) .'.css', ['elementor-frontend'], REY_CORE_VERSION );

			// Enqueue Styles
			$suffix = is_rtl() ? '-rtl' : '';
			wp_register_style( 'rey-core-elementor-frontend-css', REY_CORE_URI . 'assets/css/elementor-frontend'. $suffix . '.css', ['elementor-frontend', 'rey-core-elementor-frontend-dom-css'], REY_CORE_VERSION );
		...
		public function enqueue_frontend_styles() {
			wp_enqueue_style( 'rey-core-elementor-frontend-dom-css' );
		...
		public function register_frontend_scripts() {
			...
			wp_register_script( 'lottie', REY_CORE_URI . 'assets/js/lib/lottie.min.js', [], '5.6.8', true );
